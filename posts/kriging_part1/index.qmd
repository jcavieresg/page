...
Distance is a numerical description of how far apart things are. It is the most fundamental concept in geography. Considering the Waldo Tobler's first law of the geography which says \textcolor{blue}{`everything is related to everything else, but near things are more related than distant things'} [@tobler1970computer], we need to quantify this relationship in some way and it is not always as easy a question as it seems.
